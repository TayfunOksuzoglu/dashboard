...
import { HiArrowRight, HiChartPie, HiViewList } from 'react-icons/hi';
...
function SalesItem() {
    ...
    return (
        <Card decoration="top" decorationColor="indigo" className="max-w-full mx-auto p-4">
            ...
            <Flex className="mt-6 pt-4 border-t">
                <Button size="xs" variant="light" icon={HiArrowRight} iconPosition="right">
                    View more
                </Button>
            </Flex>
        </Card>
